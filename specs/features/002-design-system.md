...
* **Diseño Responsivo:** Enfoque *Mobile-First*. Clases de Tailwind usando prefijos de pantalla (`sm:`, `md:`, `lg:`).
* **Tipografía:** Sans-serif moderna y legible, declarada globalmente en el sistema de Tailwind.

## ✅ Criterios de Aceptación
* El diseño se adapta de forma fluida a pantallas móviles (390px), tablets y escritorios sin generar scroll horizontal (*overflow*).
